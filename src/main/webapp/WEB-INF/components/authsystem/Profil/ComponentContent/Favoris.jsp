...
<link rel="stylesheet" href="./ressources/css/STYLEC.css">
<link rel="stylesheet" href="./ressources/css/Profil/style-annonce.css">
<link rel="stylesheet" href="./ressources/css/Profil/profil.css">
...
<!-- -----------------------------------CONTENT--------------------------------------------------------------------------------->   
	      ...
	      <jsp:include page="../../../../components/authsystem/Profil/RightSideBarComponent.jsp" />
	      <div class="col-lg-12" >
	      <div class="row">
...
<script  src="./ressources/js/script.js"></script>
  ...
  <!------Traitenment de profile----->
	   <script src="./ressources/js/JSprofil/ChoixOption2.js"></script>
	   <script src="./ressources/js/JSprofil/ModificationAnn.js"></script> 
	   <script src="./ressources/js/JSprofil/UpdateInfoProfil.js"></script> 
