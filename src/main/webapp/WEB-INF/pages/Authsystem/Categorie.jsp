...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <button type="button" class="btn btn-primary btn-lg show-modal op" data-toggle="modal" data-target="#myModal" class="btn btn-primary">Ajouter Catégorie  </button>
            ...
            <table id="example" class="table table-striped table-bordered" style="width:100%">
                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                   ...
                   <div class="modal-body">
                        ...
                        <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Name" aria-describedby="emailHelp" name="name">
                    </div>
                    
                    <div class="col-lg-12 ">
                        <label id="labe2" class="fs">Description:</label>
                        <input type="text" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Description" aria-describedby="emailHelp" name="description">
                    
                    </div>     
                    <input type="hidden" name="op" value="Add">              
                     <button type="submit" class="btn btn-success btn-lg btn-block " id="btnadd">Add Categorie</button>
                    
                     	 <%          
            	 CategorieDao dp = new CategorieDao();
            ArrayList<Categorie> Categorie =dp.getAlllists();
            %>
                            </div>
                        </div>
                    </div>
                ...
                <tbody>
	            	...
	            	<tr>
	            	   <td><%= Categorie.get(i).getId() %></td>
	            		<td><%= Categorie.get(i).getNom() %></td>
	            		<td><%= Categorie.get(i).getDatecreation() %></td>
	            		<td class="icons">
                            <a href="http://localhost:8080/Mrsamsar/modifie?id=<%=Categorie.get(i).getId()%>"  class="edit vv op" value="Edit" data-toggle="tooltip"><i class="fa-solid fa-pen"  ></i></a>
                            <a  class="delete vv op" value="Delete" data-toggle="tooltip"><i class="fa-solid fa-trash" onclick=supprimer(this)></i></a>
                            <a href="http://localhost:8080/Mrsamsar/detailss?id=<%=Categorie.get(i).getId()%>"  class="visualiser vv op" value="visualiser" data-toggle="tooltip"><i class="fa-regular fa-eye" ></i></a>
                        </td>
	            	</tr>	
            		<% } %>
