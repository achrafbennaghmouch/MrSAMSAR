...
<head>
    ...
    <link rel="stylesheet" href="./ressources/css/Form-Update-Ann.css">
...
<body>
   <div class="container mt-6">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class=" mt-12 modal-header">
                        <h5 class="modal-title">Form d'Ajout</h5>
                    </div>
                    ...
                    <div class="modal-body">
                        <form>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <select class="form-select" aria-label="Default select example" id="SelectQuartier">
                                                <option selected>2mars</option>
                                                <option value="1">Maarif</option>
                                                <option value="2">Sbata</option>
                                                <option value="3">Ain chok</option>
                                              </select>
                                        </div>
                            ...
                            <div class="mb-3">
                                <div class="row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="number" id="nbrbain" class="form-control" >
                                    </div>
                                    <div class="col-lg-4">
                                        <label class="form-label required">Nombre de pieces</label>
                                        <input type="number" id="nbrpiece" class="form-control" >
                                    </div>
                                    <div class="col-lg-4">
                            ...
                            <div class="mb-3">
                                ...
                                <input  type="text"  class="form-control" id="descr" name="description" required minlength="10" maxlength="40" size="20" >
                            </div>
                        </form>  
                    </div>

                    <div class="modal-footer col-lg-5 offset-2">
                        <button type="submit" class="btn btn-success" onclick="ajouter()">Valider</button>
                        <button  class="btn btn-danger"> <a href="http://localhost:8080/MRSAMSARV2/HomeC" style="color: white ;text-decoration: none "> Annuler</a></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script src="./ressources/js/AjouterAnnonce.js"></script>
