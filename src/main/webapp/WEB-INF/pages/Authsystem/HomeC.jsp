...
<!-- ##### Header Area Start ##### -->
   <header class="header-area">
       ...
       <div class="menutop-wrap">
        ...
        <span><i class="bi bi-person-plus"></i> <button type="submit" style="border: none; background: #9d7859;color: white">Disconnect</button></span>
        ...
        <div id="stickyHeader-sticky-wrapper" class="sticky-wrapper is-sticky" style="height: 90px;"><div class="main-header-area" id="stickyHeader" style="width: 1519px; position: fixed; top: 0px; z-index: inherit;">
            <div class="classy-nav-container breakpoint-off dark left">
                ...
                <nav class="classy-navbar justify-content-between" id="southNav">
                    ...
                    <!-- Logo -->
                    <a class="nav-brand" href="http://localhost:8080/Mrsamsar/Home" ><img src="./ressources/imagesH/HomeImg/core-img/LOGOSAMS.png" alt="" style="height: 200px;
    margin-top: 35px;"></a>
                    ...
                    <div class="classy-menu">
                        ...
                        <div class="classynav">
                            <ul>
                                <li><a href="http://localhost:8080/Mrsamsar/Home">Home</a></li>
                                <li><a href="#">Acheter</a> </li>
                                <li><a href="#">Louer</a> </li>                        
                                <li><a href="http://localhost:8080/Mrsamsar/aboutus">About Us</a></li>
                                <li><a href="listings.html">Immoneuf</a></li>
                                <li><a href="http://localhost:8080/Mrsamsar/contact">Contact</a></li>
                                <li><a href="http://localhost:8080/Mrsamsar/profil">Profil</a></li>
                            </ul>
...
<section class="hero-area">
    ...
    <section class="featured-properties-area section-padding-00-70">
        <div class="container ">
            <div class="row">
                <div class="col-12">
                <div class="row">
                        <div class="col-lg-5 offset-lg-4 addAnnonce">
                          <a href="http://localhost:8080/Mrsamsar/ajouter">
                            <button class="bi-plus-circle-fill adAnn" >&nbsp; Add annonce</button></a>
                        </div>
                    </div>
                ...
                <div class="col-12 col-md-6 col-xl-4">
                    <div class="single-featured-property mb-50 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="property-thumb">
                          <a href="http://localhost:8080/Mrsamsar/details">  <img src="./ressources/imagesH/HomeImg/bg-img/<%= Annonce.get(i).getImage() %>" alt=""></a>
    ...
    <!--------------------------------------FOOTER--------------------------------------->
    <footer class="footer-area section-padding-100-0 bg-img gradient-background-overlay" style="background-image: url(./ressources/images/HomeImg/bg-img/cta.jpg);">
        <!-- Main Footer Area -->
